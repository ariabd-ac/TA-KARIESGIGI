                  ...
                  <div class="card" style="padding: 10px;">
                    <form action="" method="post" autocomplete="off" enctype="multipart/form-data">
                      ...
                      <div class="input-group mb-3">
                        <input type="text" class="form-control" name="title" id="title" placeholder="Dengan cara ini merawat kesehatan gigi" aria-label="title" aria-describedby="basic-addon1">
                      </div>
                      ...
                      <div class="input-group mb-3">
                        <input type="text" class="form-control" name="author" id="author" placeholder="Drg. Vicky" value="Drg. " aria-label="title" aria-describedby="basic-addon1">
                      </div>
