  ...
  <div id="index-banner" class="parallax-container" style="min-height: 425px;">
    <div class="section no-pad-bot">
      <div class="container mt-5 right-align">
        ...
        <h5 class="header col s12 light-text" style="text-shadow: 2px 2px #757575;">Aplikasi Diagnosa Penyakit Karies Gigi Melalui Pendekatan Sistem Pakar Menggunakan <em>Forward Chaining</em>.</h5>
        <br><br>
      </div>
    </div>
